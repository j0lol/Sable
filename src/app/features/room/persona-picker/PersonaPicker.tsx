...
export function PersonaPicker({
  ...
  const personaPickerBoard = (
    ...
    >
      <Menu style={mobileOrTablet() ? fullWidthStyle : {}}>
        <Box direction="Column" gap="100" style={{ padding: config.space.S200, minWidth: '18rem' }}>
          <Box gap="100">
            <Badge
              style={pillStyles}
              as="button"
  ...
  return (
    <>
      {mobileOrTablet() ? (
        <Overlay open={showPersonaPicker} backdrop={<OverlayBackdrop />}>
          <div
            style={{
              position: 'fixed',
              left: 0,
